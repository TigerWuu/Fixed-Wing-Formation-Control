...
* The software-in-the-loop (SITL) simulation implemented in the open-source PX4 Autopilot can be found in [Formation-PX4](https://github.com/TigerWuu/Formation-PX4)  
