...
% winds_hat = get(out.logsout, 'wind_hat').Values.Data;
% winds_hat = transpose(squeeze(winds_hat));
% winds_hat_enu = winds_hat*transpose(T.R_NED_ENU); 
% w_e_hat = winds_hat_enu(:,1);
% w_n_hat = winds_hat_enu(:,2);
% w_u_hat = winds_hat_enu(:,3);
...
%%
figure('Name','Wind');
plot(t, w_n, t, w_e, t, -w_u,'-','linewidth',1.5); hold on;
plot(t, w_n_hat,'-.', t, w_e_hat,'-.', t, -w_u_hat,'-.','linewidth',1.5);
